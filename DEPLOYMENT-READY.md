...
1. **feat(ai): dodaj multi-model support (LLM + Gemini)** - `8dab06c4`
...
doppler secrets set EXPO_PUBLIC_LLM_PROVIDER_API_KEY="<twoj_api_key>"
...
- LLM provider API: ~$0.03 per 1000 🪙 used (pass-through)
...
2. ✅ **Multi-model choice** — LLM vs Gemini (unique!)
...
**Prepared by:** Mobile Team (LLM Sonnet 4.5)
**Date:** 31 March 2026
