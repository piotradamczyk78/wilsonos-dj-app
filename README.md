...
| AI | LLM Sonnet 4.5 (LLM provider API) |
...
- DJ ma dostep do wyszukiwarki (LLM web_search tool, max 3 zapytania na odpowiedz)
...
│   ├── llm.ts                 # LLM provider API + system prompty DJ-ow
...
EXPO_PUBLIC_LLM_PROVIDER_API_KEY=twoj_api_key
